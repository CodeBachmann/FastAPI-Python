...
@router.get('/', status_code=status.HTTP_201_CREATED, response_model=List[CursoSchema])
async def get_cursos(db: AsyncSession = Depends(get_session)) -> List[CursoSchema]:
